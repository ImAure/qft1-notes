\chapter{Classical Field Theory}
    ...
    \section{Noether's theorem}
        ...
        \begin{equation*}
            ...
            \mycomma
        \end{equation*}
        where $\vb{J}$ is the spacial component of the $4$-current $\tJ{^\mu} = \pqty{\tJ{^0}, \vb{J}}$. By integrating both sides of the equation over a finite volume $\Omega \subseteq \bbR^3$, we see the volume integral of the divergence of the vector field $\vb{J}$, which may be translated to the flux of the field itself through the boundary $\partial\Omega$ of the region due to Gauss' theorem:
        \begin{align*}
