\chapter{Classical Field Theory}
    ...
    \section{Euler--Lagrange equations for fields}
        ...
        This set of differential equations, labeled by the index $i$, goes under the name of \emph{Euler--Lagrange equations for fields}.
            ...
            \caption{A solution to the Euler--Lagrange equations describes the evolution of the field through space and time. In this graph $x$ is not the $4$-vector $\pqty{t, \vb{x}}$ but rather the first spacial component in $\tensor{x}{^\mu} = \pqty{t, x, y, z}$.}
        \end{figure}
