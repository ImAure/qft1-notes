\chapter{Introduction}
    ...
    \section{Mechanical model of a quantum field}
        ...
        \begin{equation}
            ...
            \myperiod
        \end{equation}
        From this position follow the equations of motion in the new coordinates. By substituting \eqref{eq:discrete-fourier} in \eqref{eq:euler-lagrange-for-chain} we get:
        % \begin{align*}
